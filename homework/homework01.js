...
let myAge = 44,  myFavoriteNumber = 5;
let myHeight = '5\'11\"', myWeight = '190 LBS', myFavoriteLetter = 'e';
console.log(myAge);
...
let number1 = 24;
let number2 = 10;
console.log('The sum of the number is =', number1+number2);
...
console.log('The 10 multiplied with 10 is =', (b2**2));
...
console.log(`The favarite book is ${favBook}
