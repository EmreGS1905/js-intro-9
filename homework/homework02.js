...
let nmbr1 = Math.floor(Math.random()*(100-50+1)+50);
let nmbr2 = Math.floor(Math.random()*(100-50+1)+50);
let nmbr3 = Math.floor(Math.random()*(100-50+1)+50);
console.log('The number 1 =', nmbr1,'\n'+'The number 2 =',nmbr2,'\n'+'The number 3 =', nmbr3);
console.log(`The sum of numbers is = ${nmbr1 + nmbr2 + nmbr3}`);

// Task 6 

let no1 = Math.floor(Math.random()*(100)+1);
let no2 = Math.floor(Math.random()*(100)+1);
let no3 = Math.floor(Math.random()*(100)+1);
console.log(no1 > 25, no2 > 25, no3 > 25);
